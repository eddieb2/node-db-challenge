...
- [x] Explain the difference between `Relational Databases` and `SQL`.
      // SECTION
      SQL is a query language used to access and manipulate relational databases. The difference is that SQL does the communication and the relational database does the storage.

- [x] Why do tables need a `primary key`?
      // SECTION
      Primary keys make it easy to keep track of a specific record in a database.
...
- [x] What do we need in order to have a _many to many_ relationship between two tables.
      // SECTION
      Bridge tables and foreign keys.
